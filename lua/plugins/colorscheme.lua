...
function Colorscheme.init()
        ...
        vim.api.nvim_create_augroup("CustomLSPHighlights", { clear = true })
         -- for python constants
        vim.api.nvim_create_autocmd("LspTokenUpdate", {
            group = "CustomLSPHighlights",
...
function Colorscheme.on_shadesofpurple()
        ...
        vim.api.nvim_set_hl(0, "CopilotSuggestion", { fg = "#f542dd", italic = true }) -- links to Comment by default
        -- vim.api.nvim_set_hl(0, "CopilotAnnotation", { fg = "", italic = true }) -- links to Comment by default
end
