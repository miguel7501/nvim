...
vim.keymap.set('n', '<leader>ha', function() harpoon:list():add(); print("Harpoon added") end, { desc = "Harpoon: Add file" })
vim.keymap.set('n', '<leader>hr', function() harpoon:list():remove(); print("Harpoon removed") end, { desc = "Harpoon: Remove file" }) -- TODO test
vim.keymap.set('n', '<leader>hh', misc.harpoon_toggle_telescope, { desc = "Harpoon: Toggle quick menu" })
...
vim.keymap.set('n', '[h', function() harpoon:list():prev({ui_nav_wrap=true}) end, { desc = "Harpoon: Previous file" })
vim.keymap.set('n', ']h', function() harpoon:list():next({ui_nav_wrap=true}) end, { desc = "Harpoon: Next file" })
