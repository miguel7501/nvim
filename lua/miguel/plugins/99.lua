-- config copied mostly from repo
return {
    ...
    config = function()
        ...
        local cwd = vim.uv.cwd() ---@diagnostic disable-line
        ...
        _99.setup({
            ...
            completion = {
                ...
                -- source = "cmp", -- TODO figure out how to hook this into blink.cmp instead of cmp.nvim
